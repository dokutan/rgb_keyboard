...
int rgb_keyboard::keyboard::set_ajazzak33_compatibility(bool compatibility) {
	...
	if (compatibility) {
		_brightness_max =
			_brightness_max_ajazzak33; // different maximum brightness
	} else {
...
int rgb_keyboard::keyboard::set_color(uint8_t Color_r, uint8_t Color_g,
									  uint8_t Color_b) {
...
int rgb_keyboard::keyboard::set_detach_kernel_driver(
