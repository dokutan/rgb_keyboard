...
int rgb_keyboard::keyboard::get_speed() { return _speed[_profile - 1]; }
...
uint8_t rgb_keyboard::keyboard::get_color_r() { return _color_r[_profile - 1]; }

uint8_t rgb_keyboard::keyboard::get_color_g() { return _color_g[_profile - 1]; }

uint8_t rgb_keyboard::keyboard::get_color_b() { return _color_b[_profile - 1]; }

bool rgb_keyboard::keyboard::get_rainbow() { return _rainbow[_profile - 1]; }
...
int rgb_keyboard::keyboard::get_active_profile() { return _active_profile; }

int rgb_keyboard::keyboard::get_profile() { return _profile; }

bool rgb_keyboard::keyboard::get_ajazzak33_compatibility() {
	return _ajazzak33_compatibility;
}

uint16_t rgb_keyboard::keyboard::get_vid() { return _keyboard_vid; }

uint16_t rgb_keyboard::keyboard::get_pid() { return _keyboard_pid; }
