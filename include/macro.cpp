...
uint8_t rgb_keyboard::macro::get_repeats() { return _repeats; }
...
int rgb_keyboard::macro::get_action(unsigned int number, action_type &type,
									std::string &key, unsigned int &delay) {
...
int rgb_keyboard::macro::append_action(action_type type, std::string key,
									   unsigned int delay) {
